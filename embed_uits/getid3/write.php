...
throw new Exception('$this->overwrite_tags=false is known to be buggy in this version of getID3. Will be fixed in the near future, check www.getid3.org for a newer version.');
	...
	public function FormatDataForID3v1() {
		...
		$tag_data_id3v1['hero']    =        getid3_lib::iconv_fallback($this->tag_encoding, 'ISO-8859-1', implode(' ', (isset($this->tag_data['HERO']       ) ? $this->tag_data['HERO']        : array())));
	...
	public function FormatDataForReal() {
		...
		$tag_data_real['hero']      = getid3_lib::iconv_fallback($this->tag_encoding, 'ISO-8859-1', implode(' ', (isset($this->tag_data['HERO']   ) ? $this->tag_data['HERO']    : array())));
